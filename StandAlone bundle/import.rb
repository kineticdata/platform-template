...
#Export_command ocra import.rb --no-dep-run --add-all-core --gem-files C:\Ruby32-x64\bin\ruby_builtin_dlls --gem-scripts C:\Ruby32-x64\lib\ruby\gems\3.2.0\gems\kinetic_sdk-5.0.21 --gemfile ../Gemfile
